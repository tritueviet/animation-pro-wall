...
//	protected BufferedImage lastImage; // previous frame
	protected static Image imageData; // current frame
	protected static Image lastImage; // previous frame
...
//        protected ArrayList frames;       // For J2SE - frames read from current file
...
// copy each source line to the appropriate place in the destination
		...
		for (int i = 0; i < ih; i++) {
			...
			if (line < height) {
                ...
                imageData = Image.createRGBImage(dest, width, height, false) ;
	} // end setPixels()
...
//		frames.add(new GifFrame(imageData, delay)); // add image to frame list
